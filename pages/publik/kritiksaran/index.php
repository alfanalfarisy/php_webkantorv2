                        ...
                        <div class="row p-t-40">
                            <form id="contact-form" action="" method="POST" novalidate="novalidate">
                                ...
                                <div class="col-12 mb-3">
                                        ...
                                        <input  class="form-control" type="text" placeholder="No Telp/HP" class="keyword-input" name="phone" id="phone">
                                ...
                                <div class="col-12 mb-3">
                                        ...
                                        <textarea  class="form-control" placeholder="Isi Pesan" name="message" id="message" required="required"></textarea>
