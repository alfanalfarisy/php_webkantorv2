  ...
  <div class="container">
    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block" style="background-image: url('images/pemohon.jpg');background-position:center;background-size:cover"></div>
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <input type="hidden" name="golongan" value="<?= $_GET['pilihan'] ?>">
                ...
                <div class="form-group">
                  <div class="mb-3">
                    <label for="formFile" class="form-label">Surat Pengantar Permohonan Data Dari Sekolah/Kampus</label>
