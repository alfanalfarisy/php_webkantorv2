...
//     $mail->SMTPAuth   = true;
//     $mail->Username   = 'layanan.bmkgjuanda@gmail.com';
//     $mail->Password   = 'juanda96935';
//     $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
//     $mail->Port       = 587;
//     $mail->setFrom('layanan.bmkgjuanda@gmail.com', 'BMKG Stasiun Meteorologi Juanda Sidoarjo');
//     $mail->addAddress($email);
//     $mail->addCC('layanan.bmkgjuanda@gmail.com');
//     if ($golongan == 3) {
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="exampleLastName"
                                            placeholder="Nama Instansi/Perusahaan" name="instansi" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="tel" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="Nomor Whatsapp" name="whatsapp"
                                            required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="email" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Email" name="email" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="jasa" id="jasa1"
                                            onclick="tutup()" value="Analisis Curah Hujan Bulanan">
                                        <label class="form-check-label" for="jasa1">Analisis Curah Hujan
                                            Bulanan</label><br>
                                        <input class="form-check-input" type="radio" name="jasa" id="jasa2"
                                            onclick="tutup()" value="Informasi Cuaca Khusus Untuk Komersial">
                                        <label class="form-check-label" for="jasa2">Informasi Cuaca Khusus Untuk
                                            Komersial</label><br>
                                        <input class="form-check-input" type="radio" name="jasa" id="jasa3"
                                            onclick="tutup()" value="Informasi Radar Cuaca">
                                        <label class="form-check-label" for="jasa3">Informasi Radar Cuaca</label><br>
                                        <input class="form-check-input" type="radio" name="jasa" id="jasa4"
                                            onclick="tutup()"
                                            value="Informasi Meteorologi Untuk Klaim Asuransi Dan Data Dukung">
                                        <label class="form-check-label" for="jasa4">Informasi Meteorologi Untuk Klaim
                                            Asuransi Dan Data Dukung</label><br>
                                        <input class="form-check-input" type="radio" name="jasa" id="jasa5"
                                            onclick="buka()" value="Keperluan Lain">
                                        <label class="form-check-label" for="jasa5">Keperluan Lain</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input id="keperluan" type="text" class="form-control form-control-user"
                                        placeholder="Keperluan" disabled name="keperluan">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="Tanggal/Periode" name="tanggal" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="Lokasi/Wilayah" name="lokasi" required>
                                </div>
                                <?php
                                if ($_GET['pilihan'] != 3) {
                                ?>
                                <div class="form-group">
                                    <div class="mb-3">
                                        <p><a href="https://juanda.jatim.bmkg.go.id/webkantor/tarif.php"
                                                target="_blank">Jenis Layanan dan Tarif</a></p>
                                    </div>
                                </div>
                                <?php
                                } else {
                                ...
                                ?>
                                <button id="keperluan" type="submit" class="btn btn-primary btn-user btn-block"
                                    name="ajukan" onclick="terisi()">Ajukan</button>
                            </form>
                        </div>
                    </div>
                </div>
