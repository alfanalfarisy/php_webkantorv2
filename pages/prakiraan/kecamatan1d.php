    ...
    <section class="container">
        <div class="card p-4 box-shadow">
            <div class="prakicu-kabkota tab-v1">
                ...
                <div class="prakicu-kabkota tab-v1">
                    <h2 id="jdl" class="text-center">Prakiraan Cuaca Hari Ini</h2>
    ...
    function load(id) {
        $.ajax({
            ...
            success: function(result) {
                ...
                document.getElementById("img_prakicu").src = "https://juanda.jatim.bmkg.go.id/data/prakicu_img/" + result.prakicu_d0;
