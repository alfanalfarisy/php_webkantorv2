         ...
         <div class="row">
             ...
             <div class="col-lg-4 col-md-4">
                 <div class="contact-about">
                     ...
                     <hr>
                     <div class="d-flex align-items-center mt-3">
                         <i class="bi bi-envelope"><a href="mailto:stamet.juanda@bmkg.go.id" target="_blank">
                                 stamet.juanda@bmkg.go.id</i></a>
                     </div>
                     <hr>
                     <div class="d-flex align-items-center mt-3">
             ...
             <div class="col-lg-4 col-md-8">
                 ...
                 <div class="d-flex align-items-center mt-2">
                     <iframe style="border:0; width: 400px; height: 270px;"
                 ...
                 <div class="d-flex align-items-center mt-3">
                     <i class="bi bi-geo-alt"> Jl. Raya Bandara Juanda, Pranti, Kec. Sedati, Kabupaten Sidoarjo, Jawa
                         Timur 61253</i>
                 </div>
             </div>
         </div>
