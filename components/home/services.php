        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            ...
            <div class="icon-box">
              ...
              <p class="description">Informasi cuaca bandara update setiap 30 menit bersumber dari data METAR yang diterjemahkan.</p>
            </div></a>
          </div>
          <!-- LAYANAN 2 -->
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            ...
            <div class="icon-box">
              ...
              <p class="description">Memuat informasi analisis angin dan prakiraan angin serta informasi lainnya.</p>
            </div></a>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            ...
            <div class="icon-box">
              ...
              <p class="description">Memuat informasi Citra Satelit Himawari Jawa Timur update setiap 10 menit.</p>
            </div></a>
          </div>
          <!-- LAYANAN 4 -->
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            ...
            <div class="icon-box">
              ...
              <p class="description">Memuat informasi cuaca berupa evaluasi cuaca bulan lalu dan prakiraan cuaca sebulan kedepan.</p>
            </div></a>
          </div>
          <!-- LAYANAN 6 -->
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            ...
            <div class="icon-box">
              ...
              <p class="description">Memuat informasi pengamatan debu vulkanik dan prakiraan cuaca sekitar G. Semeru.</p>
            </div></a>
          </div>
          <!-- LAYANAN 8 -->
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
