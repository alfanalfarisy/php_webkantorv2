...
$pelabuhan = array();
$pelabuhan['501279'] = 'Pel. Gresik';
$pelabuhan['5008230'] = 'Pelabuhan Sangkapura';
$pelabuhan['501295'] = 'Pel. Perikanan PPP Tamperan';
$pelabuhan['5008358'] = 'Pel. Tanjung Perak ';
$pelabuhan['501305'] = 'Pel. Kalianget';
$pelabuhan['5008672'] = 'Pel. Jangkar';
$pelabuhan['5008345'] = 'Pel. Perikanan PP Mayangan';
$pelabuhan['501273'] = 'Pel. Ketapang';
...
$sql = "SELECT c.idkab, c.idkec, c.namakec, c.latitude, c.longitude, b.namakab, b.logo, b.prakicu FROM kecamatan c, kabupaten b where c.idkab=b.idkab and c.idkec in ('501279','5008230','501295','5008358','501305','5008672','5008345','501273') ORDER BY b.namakab, c.namakec ASC";
...
while( $row=mysqli_fetch_array($query) ) {
	...
	$kec['namapel'] = $pelabuhan[$row['idkec']];
	$kec['idkec'] = $row['idkec'];
...
$fp = fopen('data/prakicu_pelabuhan.json', 'w');
fwrite($fp, json_encode($allkecdata));
fclose($fp);
?>
