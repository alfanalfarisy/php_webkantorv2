...
$gunung = array();
$gunung['5008415'] = 'Gunung Semeru';
$gunung['5008632'] = 'Gunung Bromo';
$gunung['5008207'] = 'Gunung Ijen';
$gunung['5008454'] = 'Gunung Lawu';
$gunung['5008492'] = 'Gunung Kawi';
$gunung['5008137'] = 'Gunung Raung';
...
$sql = "SELECT c.idkab, c.idkec, c.namakec, c.latitude, c.longitude, b.namakab, b.logo, b.prakicu FROM kecamatan c, kabupaten b where c.idkab=b.idkab and c.idkec in ('5008415','5008632','5008207','5008454','5008492','5008137') ORDER BY b.namakab, c.namakec ASC";
...
while( $row=mysqli_fetch_array($query) ) {
	...
	echo $row['idkec'].PHP_EOL;
	$kec['namagun'] = $gunung[$row['idkec']];
	$kec['idkec'] = $row['idkec'];
...
$fp = fopen('data/prakicu_gunung.json', 'w');
fwrite($fp, json_encode($allkecdata));
fclose($fp);
?>
